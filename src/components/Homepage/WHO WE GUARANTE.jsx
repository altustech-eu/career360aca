        ...
        <div className="flex flex-col lg:flex-row justify-between items-end mb-16 gap-8">
          <div className="max-w-2xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.3em] text-emerald-600">Our Commitment</span>
            </div>
            <h2 className="text-4xl lg:text-6xl font-medium tracking-tighter text-slate-900 leading-tight uppercase">
              How We Guarantee <br />
              <span className="text-slate-400 font-light italic">100% Success</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border border-slate-200">
          {pillars.map((pillar, idx) => (
            ...
            >
              ...
              <div className={`h-1 w-0 group-hover:w-full transition-all duration-500 ${pillar.bg.replace('bg-', 'bg-').replace('50', '500')}`} />
            </div>
          ))}
        </div>

        {/* Trust Banner */}
        <div className="mt-16 bg-slate-900 p-8 lg:p-12 flex flex-col lg:flex-row items-center justify-between gap-8">
           <div className="flex items-center gap-6">
              <div className="w-16 h-16 border border-white/10 flex items-center justify-center">
                 <Icon icon="solar:shield-star-bold-duotone" className="text-white text-4xl" />
              </div>
              <div>
           ...
           <button className="px-10 py-4 bg-white text-slate-900 text-[11px] font-black uppercase tracking-[0.2em] hover:bg-emerald-500 hover:text-white transition-all">
